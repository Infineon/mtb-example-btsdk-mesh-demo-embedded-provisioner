...
1. Build and download the application to several WICED Kits.
2. Push and release a button on one of the kits to set it up as an embedded provisioner.
3. For 20721B2 based WICED kits, use the Custom button on audio shield board as application button rather than the button on the base board.
